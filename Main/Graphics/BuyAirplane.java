...
import Main.Vehicles.Passenger_airplane;
 ...
 * @author erfan
 */
public class BuyAirplane extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        flightAttendants = new javax.swing.JSpinner();
        ...
        runway = new javax.swing.JSpinner();
...
//        });
        ...
        jLabel7.setText("Flight Attendants :");

        flightAttendants.setValue(5);
        ...
        buyButton.setText("Buy Airplane");
        ...
        jLabel11.setText("Airplane Price :");
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                .addComponent(flightAttendants, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addGap(95, 95, 95)
                                                                ...
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                                        ...
                                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                .addGroup(layout.createSequentialGroup()
                                                                                        ...
                                                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                        .addComponent(runway, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                        .addGroup(layout.createSequentialGroup()
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                                        ...
                                                                        .addComponent(flightAttendants, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                                        .addComponent(jLabel8)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        ...
                                                        .addComponent(runway, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGap(5, 5, 5)))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(35, 35, 35)
    ...
    private void buyButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (Main.selectedCity.getBudget() >=800 && dlm.size()!=0 && terminal.max_number_of_vehicle() > terminal.getNumber_of_bought_vehicles()  ){

            Passenger_airplane newAirplane;

            try {
                newAirplane = new Passenger_airplane((int)flightAttendants.getValue() , "None" , (int)height.getValue() , (int)runway.getValue()
                , (int)capacity.getValue() , id.getText() ,"Company");
            }
            ...
            terminal.addVehicle(newAirplane);
            Main.selectedCity.withdrawalBudget(800);
...
//            java.util.logging.Logger.getLogger(BuyAirplane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new BuyAirplane().setVisible(true);
//            }
//        });
//    }
    ...
    private javax.swing.JSpinner flightAttendants;
    ...
    private javax.swing.JSpinner runway;
