...
public class CargoPlane extends Air_transport_vehicle {
    ...
    public CargoPlane(int total_weight, int max_flight_height, int runway_length, int capacity, String ID, String companyName , boolean save){
    ...
    public void restoreCargoPlane() throws IOException {
        ...
        while (sc.hasNextLine()) {
            ...
            CargoPlane newCargoPlane = new CargoPlane( Integer.parseInt(cargoPlane[0]) ,  Integer.parseInt(cargoPlane[1]) ,  Integer.parseInt(cargoPlane[2])  ,  Integer.parseInt(cargoPlane[3]) , cargoPlane[4] , cargoPlane[5] , false );
