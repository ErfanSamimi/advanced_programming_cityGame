...
public class Boat extends Shipping_vehicle{
    ...
    public Boat(int max_distance, String fuel_type, int min_depth, int capacity, String ID, String companyName , boolean save){
    ...
    public void saveBoat() throws IOException {
        ...
        FileOutputStream fout = new FileOutputStream("home/erfan/Projects/Java/Files/CityGame/boats.csv" , true);
    ...
    public void restoreBoats() throws IOException {

        FileInputStream fin = new FileInputStream("home/erfan/Projects/Java/Files/CityGame/boats.csv" );
        ...
        while (sc.hasNextLine()) {
            ...
            Boat newBoat = new Boat(Integer.parseInt(boat[0])  , boat[1] , Integer.parseInt(boat[2])  ,  Integer.parseInt(boat[3]) , boat[4] , boat[5] , false);
        }
